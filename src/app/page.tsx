        ...
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 group cursor-pointer">
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-br from-primary/30 to-indigo-500/30 rounded-2xl blur-md group-hover:blur-lg transition-all duration-300" />
              <div className="relative bg-linear-to-br from-primary/20 to-indigo-500/20 p-3 rounded-2xl ring-1 ring-inset ring-foreground/10 shadow-lg shadow-primary/10 group-hover:scale-105 transition-transform duration-300">
                <Code2 className="w-6 h-6 text-primary" />
              </div>
            </div>
            <div className="flex flex-col">
              <h1 className="text-2xl font-bold font-playfair tracking-tight bg-clip-text text-transparent bg-linear-to-r from-foreground via-primary to-indigo-600 dark:from-foreground dark:via-primary dark:to-indigo-400">
                Code Review Agent
              </h1>
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            >
              Features
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-linear-to-r from-indigo-500 to-purple-500 group-hover:w-full transition-all duration-300 ease-out"></span>
            </a>
            <a
              href="#how-it-works"
              className="relative px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors duration-200 group"
